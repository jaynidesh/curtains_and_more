...
@Component({
  selector: 'app-le-clubhouse',
  templateUrl: './le-clubhouse.page.html',
  styleUrls: ['./le-clubhouse.page.scss'],
})
export class LeClubhousePage implements OnInit {
    ...
    this.hotelReservation = new FormGroup({
      ...
      form_data: new FormGroup({
        item_A: new FormGroup({
          question:  new FormControl("On which date do you which to book Le Clubhouse?", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
          rawValue:  new FormControl("", [Validators.required]),
        }),
        item_B: new FormGroup({
          question:  new FormControl("At what time do you wish to book Le Clubhouse?", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
          rawValue:  new FormControl("", [Validators.required]),
        }),
        item_C: new FormGroup({
          question:  new FormControl("Name of guests accompanying you (if any)", [Validators.required]),
          value:  new FormControl(""),
        }),
        item_D: new FormGroup({
          question:  new FormControl("What are the facilities that you want to access?", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
        }),
        item_E: new FormGroup({
          question:  new FormControl("Any additional queries that might have ", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
        }),
      }),
  ...
  onContentScroll(event) {
    ...
    submitForm(){
      ...
      if (!this.hotelReservation.valid) {
        ...
        this.firebaseDataCollectionService.saveConciergeReservation('le_clubhouse', JSON.stringify(formdata)).then( () =>{
