...
@Component({
  ...
  templateUrl: './leisure.page.html',
  styleUrls: ['./leisure.page.scss'],
})
export class LeisurePage implements OnInit {
    ...
    this.hotelReservation = new FormGroup({
      ...
      form_data: new FormGroup({
        item_A: new FormGroup({
          question:  new FormControl("Where do you want your adventure to begin?", [Validators.required]),
        ...
        item_C: new FormGroup({
          question:  new FormControl("Number of kids (if any)", [Validators.required]),
          value:  new FormControl(""),
        }),
        item_D: new FormGroup({
          question:  new FormControl("Age of the kid(s) (if any)", [Validators.required]),
          value:  new FormControl(""),
        }),
        item_E: new FormGroup({
          question:  new FormControl("Activities that you are interested in", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
        }),
        item_F: new FormGroup({
          question:  new FormControl("Additional facilities that you will might need", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
        }),
        item_G: new FormGroup({
          question:  new FormControl("Date of the Reservation", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
          rawValue:  new FormControl("", [Validators.required]),
        }),
        item_H: new FormGroup({
          question:  new FormControl("Time of the Reservation", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
          rawValue:  new FormControl("", [Validators.required]),
        }),
  ...
  onContentScroll(event) {
    ...
    submitForm(){
      ...
      if (!this.hotelReservation.valid) {
        ...
        this.firebaseDataCollectionService.saveConciergeReservation('leisure', JSON.stringify(formdata)).then( () =>{
