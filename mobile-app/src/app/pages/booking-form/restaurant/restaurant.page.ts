    ...
    this.hotelReservation = new FormGroup({
      ...
      form_data: new FormGroup({
        item_A: new FormGroup({
          question:  new FormControl("Where do you wish to dine?", [Validators.required]),
        ...
        item_E: new FormGroup({
          question:  new FormControl("Please indicate any dietary restrictions or preferences", [Validators.required]),
          value:  new FormControl("", [Validators.required]),
        }),
  ...
  onContentScroll(event) {
    ...
    submitForm(){
      ...
      if (!this.hotelReservation.valid) {
        ...
        this.firebaseDataCollectionService.saveConciergeReservation('restaurant', JSON.stringify(formdata)).then( () =>{
